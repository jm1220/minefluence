...
public final class MineFluenceMissionSelectionService {
	...
	public static MineFluenceMissionBoardState boardState(ServerPlayerEntity player) {
		...
		String message = data.hasPendingMissionSelection()
				? "Choose a route for mission " + missionIndex + "."
				: "Previewing the next mission slot. Choose a route to start it.";
		return MineFluenceMissionBoardState.choices(missionIndex, true, message);
	}
